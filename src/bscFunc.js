...
export default async function bscFunc(funcType, account, network, checkOne, infuraCode) {
...
const ethToCsv = async (address, network, infuraCode) => {
    ...
    //     contract1 = new web3.eth.Contract(ContractPath.snapshot2ABI, ContractPath.snapshotContractBSCTestnet);
    // }else if(network == "mainnet"){
    //     web3 = new Web3('https://bsc-dataseed1.binance.org/');
    //     contract1 = new web3.eth.Contract(ContractPath.snapshot2ABI, ContractPath.snapshotContractBSC);
    // }
    // console.log(web3);
    let start = 1;
